const CUBLAS_STATUS_SUCCESS = Cint(0)
const CUBLAS_STATUS_NOT_INITIALIZED = Cint(1)
const CUBLAS_STATUS_ALLOC_FAILED = Cint(3)
const CUBLAS_STATUS_INVALID_VALUE = Cint(7)
const CUBLAS_STATUS_ARCH_MISMATCH = Cint(8)
const CUBLAS_STATUS_MAPPING_ERROR = Cint(11)
const CUBLAS_STATUS_EXECUTION_FAILED = Cint(13)
const CUBLAS_STATUS_INTERNAL_ERROR = Cint(14)
const CUBLAS_STATUS_NOT_SUPPORTED = Cint(15)
const CUBLAS_STATUS_LICENSE_ERROR = Cint(16)
